...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedList = $('<ul class="selected connected-list"><li class="ui-helper-hidden-accessible"></li></ul>').bind('selectstart', function(){return true;}).appendTo(this.selectedContainer);
